  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {/* FAVOR Tactical Override Badge */}
        {state.tacticalOverride?.type === 'FAVOR' && (
          <div className="absolute -top-1 -left-1 bg-amber-400 text-slate-950 rounded-full w-4 h-4 flex items-center justify-center text-[8px] font-black shadow" title="Position FAVORED">
